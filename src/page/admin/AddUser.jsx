...
function AddUserPage() {
    return (
        <div className='bg-neutral-100 h-screen flex flex-col justify-center items-center'>
            <h1 className='text-2xl font-bold'>เพิ่มข้อมูลผู้ใช้</h1>
            <form action="" className='p-4 flex flex-col gap-4 w-1/2 bg-white  border shadow-md rounded-md mt-4'>
                ...
                <hr />
                <div>
                    <button className='w-full mb-3 px-4 py-2 bg-emerald-500 hover:bg-emerald-700 transition shadow-md text-white rounded-md'>เพิ่มผู้ใช้</button>
                </div>
            </form>
        </div>
    )
